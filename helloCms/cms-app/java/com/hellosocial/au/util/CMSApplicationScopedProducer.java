...
public class CMSApplicationScopedProducer {
    ...
    public EntityManagerFactory produceEntityManagerFactory() {
        if (this.emf == null) {
            this.emf = Persistence.createEntityManagerFactory("com.hellosocial.newTask");
        }
        return this.emf;
    }
    ...
    public RuntimeEnvironment produceEnvironment(EntityManagerFactory emf) {
        RuntimeEnvironment environment = RuntimeEnvironmentBuilder
                ...
                .addAsset(ResourceFactory.newClassPathResource("CMSworkflow.bpmn2"),ResourceType.BPMN2).get();
        return environment;
    }
