...
public class RuleServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		String contentCatogoryId = (String) request
				.getParameter("contentCatogoryid");
		System.out.println("hello value is" + contentCatogoryId);
		JSONObject jsonObj = new JSONObject();
		try {

			jsonObj.put("ruleList", contentService.getRuleListJson(Integer
					.parseInt(contentCatogoryId)));
		...
		RequestDispatcher dispatcher = context
				.getRequestDispatcher("/getRule.jsp");
